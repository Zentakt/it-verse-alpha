                                            ...
                                            <div className="flex-1 space-y-8 max-w-xl">
                                                <div className="bg-[#111] p-8 rounded-xl border border-white/10 space-y-6">
                                                    ...
                                                    <div className="pt-6 border-t border-white/5">
                                                        ...
                                                        {/* Synapse Link Config */}
                                                        {activeChallenge.gameType === '4pics' && (
                                                            <div className="space-y-4 bg-blue-900/10 p-4 rounded-lg border border-blue-500/30">
                                                                <h4 className="text-blue-400 font-bold font-mono text-xs uppercase tracking-widest">Synapse Link Configuration</h4>
                                                                <p className="text-xs text-gray-400">Provide 4 Image URLs that link to the answer.</p>
                                                                <div className="grid grid-cols-2 gap-4">
                                                                    {[0, 1, 2, 3].map(idx => (
                                                                        <div key={idx}>
                                                                            <label className="text-[10px] text-gray-500 font-bold uppercase mb-1 block">Image {idx + 1}</label>
                                                                            <input
                                                                                type="text"
                                                                                value={activeChallenge.gameConfig?.images?.[idx] || ''}
                                                                                onChange={(e) => {
                                                                                    const newImages = [...(activeChallenge.gameConfig?.images || ['', '', '', ''])];
                                                                                    newImages[idx] = e.target.value;
                                                                                    handleChallengeUpdate('gameConfig', { ...activeChallenge.gameConfig, images: newImages });
                                                                                }}
                                                                                className="w-full bg-black border border-white/20 text-white p-2 rounded text-xs focus:border-blue-500 outline-none"
                                                                                placeholder="https://..."
                                                                            />
                                                                        </div>
                                                                    ))}
                                                        ...
                                                        {/* Lexicon Branch Config */}
                                                        {activeChallenge.gameType === 'wordle' && (
                                                            <div className="bg-pink-900/10 p-4 rounded-lg border border-pink-500/30">
                                                                <h4 className="text-pink-400 font-bold font-mono text-xs uppercase tracking-widest flex items-center gap-2"><AlertCircle size={12} /> Configuration Note</h4>
                                                                <p className="text-gray-300 text-sm mt-2">
                                                                    Ensure the <strong>Correct Answer</strong> field above is set to a valid <strong>5-letter word</strong> (or any fixed length).
                                                                    The game will automatically adapt to the length of the answer provided.
                                                                </p>
                                                            </div>
                                                        )}

                                                        {/* Cognitive Camouflage Config */}
                                                        {activeChallenge.gameType === 'visual_count' && (
                                                            <div className="space-y-4 bg-orange-900/10 p-4 rounded-lg border border-orange-500/30">
                                                                <h4 className="text-orange-400 font-bold font-mono text-xs uppercase tracking-widest">Cognitive Camouflage Config</h4>
                                                                <div>
                                                                    <label className="text-[10px] text-gray-500 font-bold uppercase mb-1 block">Puzzle Image URL</label>
                                                                    <input
                                                                        type="text"
                                                                        value={activeChallenge.gameConfig?.image || ''}
                                                                        onChange={(e) => handleChallengeUpdate('gameConfig', { ...activeChallenge.gameConfig, image: e.target.value })}
                                                                        className="w-full bg-black border border-white/20 text-white p-3 rounded text-sm focus:border-orange-500 outline-none"
                                                                        placeholder="https://..."
                                                                    />
                                                                </div>
                                                                <p className="text-xs text-gray-400">
                                                                    Set the <strong>Correct Answer</strong> field above to the number of items to count.
                                                                </p>
                                                            </div>
                                                        )}
                                                    </div>
